<template name="PaiementSuccesPage">

  <q-page :class="(!connexionState) ? 'disabled q-page bg-green-7' : 'q-page bg-green-7'" :style-fn="heightAuto">
    ...
    <transition v-show="bloc_show" appear enter-active-class="animated fadeIn" leave-active-class="animated fadeOut">
      ...
      <div class="column text-center w-100 form-w" style="align-items: center;margin-bottom: 50px;">
        ...
        <q-icon name="task_alt" size="100px" style="color:#d7d4d4cf" />

        <h5 class="q-mt-md q-mb-none" style="text-transform: none;color:white !important">Paiement validé.</h5>

        <h5 class="q-mt-none q-mb-md"
          style="text-transform: none;color:white !important; font-weight: normal; font-size: 15px;">Votre
          paiement a bien été pris
          en
          compte.</h5>

        <q-btn @click="this.$router.push('/')" class="w-100 q-pa-sm bg-white" style="border-radius: 10px;" size="lg"
          v-ripple>
          <span class="text-bold text-green-7" style="font-size: 15px; text-transform: none;">Retour à l'accueil</span>
        </q-btn>
